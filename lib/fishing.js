(function (root, factory) {
  ...
  // Art filenames live in assets/fish/<id>.svg (or the path on each row).
  // Drop matching images there — the UI hides a missing file and keeps the name.
  var SPECIES = [
    { id: 'bluegill', name: 'Bluegill', rarity: 'common', art: 'assets/fish/bluegill.svg' },
    { id: 'yellow-perch', name: 'Yellow Perch', rarity: 'common', art: 'assets/fish/yellow-perch.svg' },
    { id: 'creek-chub', name: 'Creek Chub', rarity: 'common', art: 'assets/fish/creek-chub.svg' },
    { id: 'pumpkinseed', name: 'Pumpkinseed Sunfish', rarity: 'common', art: 'assets/fish/pumpkinseed.svg' },
    { id: 'brown-bullhead', name: 'Brown Bullhead', rarity: 'common', art: 'assets/fish/brown-bullhead.svg' },
    { id: 'prickly-sculpin', name: 'Prickly Sculpin', rarity: 'common', art: 'assets/fish/prickly-sculpin.svg' },
    { id: 'rainbow-trout', name: 'Rainbow Trout', rarity: 'uncommon', art: 'assets/fish/rainbow-trout.svg' },
    { id: 'largemouth-bass', name: 'Largemouth Bass', rarity: 'uncommon', art: 'assets/fish/largemouth-bass.svg' },
    { id: 'smallmouth-bass', name: 'Smallmouth Bass', rarity: 'uncommon', art: 'assets/fish/smallmouth-bass.svg' },
    { id: 'kokanee', name: 'Kokanee', rarity: 'uncommon', art: 'assets/fish/kokanee.svg' },
    { id: 'mountain-whitefish', name: 'Mountain Whitefish', rarity: 'uncommon', art: 'assets/fish/mountain-whitefish.svg' },
    { id: 'chinook-salmon', name: 'Chinook Salmon', rarity: 'rare', art: 'assets/fish/chinook-salmon.svg' },
    { id: 'winter-steelhead', name: 'Winter Steelhead', rarity: 'rare', art: 'assets/fish/winter-steelhead.svg' },
    { id: 'white-sturgeon', name: 'White Sturgeon', rarity: 'rare', art: 'assets/fish/white-sturgeon.svg' },
    { id: 'bull-trout', name: 'Bull Trout', rarity: 'rare', art: 'assets/fish/bull-trout.svg' },
    { id: 'golden-mirror-carp', name: 'Golden Mirror Carp', rarity: 'exotic', art: 'assets/fish/golden-mirror-carp.svg' },
    { id: 'phantom-kokanee', name: 'Phantom Kokanee', rarity: 'exotic', art: 'assets/fish/phantom-kokanee.svg' },
    { id: 'caldris-sunfish', name: 'Caldris Sunfish', rarity: 'exotic', art: 'assets/fish/caldris-sunfish.svg' },
    { id: 'moonscale-bass', name: 'Moonscale Bass', rarity: 'exotic', art: 'assets/fish/moonscale-bass.svg' }
  ];
